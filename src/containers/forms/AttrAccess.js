            ...
            <form className='access' onSubmit={this.props.handleAccessFormSubmit}>
               <div className='parking'>
                  ...
                  <div className='more-info'>
                     ...
                     <textarea rows='5' cols='20' name='car_park' placeholder='e.g. how many blue badge parkig spaces/distance from the main entrance?' onChange={this.props.handleChange} />
                  </div>
               </div>
               <div className='accessibility'>
                  <label className='middle'>How accessable is the main entrance and any alternative entrances?</label>
                  <textarea rows='5' cols='20' name='accessibility' placeholder='e.g. step free/level access?' onChange={this.props.handleChange} required />
               </div>
               <div className='door-type'>
                  <label className='middle'>What type of door is there on entry to the building?</label>
                  <textarea rows='5' cols='20' name='door_type' placeholder='e.g. push/pull?' onChange={this.props.handleChange} required />
               </div>
               <div className='counter'>
                  <label className='middle'>What is the height of the ticket/entry counter on entry to the attraction?</label>
                  <textarea rows='5' cols='20' name='counter_height' placeholder='e.g. Desk/counter is medium height (77cm-109cm) with a lower section below 76cm' onChange={this.props.handleChange} required />
               </div>
